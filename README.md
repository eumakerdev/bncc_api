...
| Recurso                        | Descrição                                                                                                                                                                                                                                              |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 📖 **BNCC completa**           | As **3 etapas** (EI/EF/EM): 1.721 habilidades, 10 competências gerais e toda a taxonomia oficial — etapas, áreas, componentes, unidades temáticas e objetos de conhecimento.                                                                           |
| 💻 **Computação**              | O **Complemento de Computação à BNCC** (Parecer CNE/CP 02/2022): 141 habilidades `CO` nas 3 etapas, com os eixos **Pensamento Computacional**, **Mundo Digital** e **Cultura Digital** (EI/EF). Filtráveis por `componente=computacao` e por `eixo`.   |
